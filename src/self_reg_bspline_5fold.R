...
for(fold_iter in 2:3) {
  ...
  if(ajustar_modelos) {
    ...
    #summary(res.basis)
    saveRDS(res.basis, paste('SelfReg2 - BSpline - FuncReg - Fold', fold_iter,'.rds'))
    ...
    saveRDS(model_lasso, paste('SelfReg2 - BSpline - LASSO - Fold', fold_iter, '.rds'))
    ...
    saveRDS(model_rf, paste('SelfReg2 - BSpline - Random Forest - Fold', fold_iter,'.rds'))
  }
  ...
  funcreg_model <- readRDS(paste('SelfReg2 - BSpline - Funcreg - Fold', fold_iter,'.rds'))
  ...
  lasso_xtrain_colmeans = apply(lasso_xtrain_matrix,2,mean)
  lasso_xtrain_colsd = apply(lasso_xtrain_matrix,2,sd)
  lasso_model <- readRDS(paste('SelfReg2 - BSpline - LASSO - Fold', fold_iter,'.rds'))
  ...
  rforest_model <- readRDS(paste('SelfReg2 - BSpline - Random Forest - Fold', fold_iter,'.rds'))
